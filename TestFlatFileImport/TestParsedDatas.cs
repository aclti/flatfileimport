...
namespace TestFlatFileImport
{
    public class TestParsedDatas
    {
        ...
        public void TestInterfaceComposition()
        {
            ...
            root.Last().Datas.Last().AddField("id", "010428182009003", typeof(string));
            root.Last().Datas.Last().AddLine(D3001);
            root.Last().Datas.Last().AddLine(D3001);
            root.Last().Datas.Last().AddParsedData(D4000);
            root.Last().Datas.Last().Datas.Last().AddParsedData(P0000);
            root.Last().Datas.Last().Datas.Last().Datas.Last().AddLine(P1000);
            root.Last().Datas.Last().Datas.Last().Datas.Last().AddLine(P2000);
            root.Last().Datas.Last().Datas.Last().Datas.Last().AddLine(P4000);
            root.Last().Datas.Last().Datas.Last().Datas.Last().AddLine(P4000);
            root.Last().Datas.Last().Datas.Last().AddLine(P9999);
            root.Last().Datas.Last().AddLine(D6000);
            root.Last().Datas.Last().AddLine(D6000);
            root.Last().Datas.Last().AddLine(D6000);
            root.Last().AddLine(D9999);
            root.Last().AddParsedData(D1000);
            root.Last().Datas.Last().AddField("id", "089241892009002", typeof(string));
            root.Last().Datas.Last().AddLine(D3001);
            root.Last().Datas.Last().AddLine(D3001);
            root.Last().Datas.Last().AddParsedData(D4000);
            root.Last().Datas.Last().Datas.Last().AddParsedData(P0000);
            ...
            root.Last().Datas.Last().Datas.Last().Datas.Last().AddLine(P4000);
            root.Last().Datas.Last().Datas.Last().AddLine(P9999);
            root.Last().Datas.Last().AddLine(D5000);
            root.Last().Datas.Last().AddLine(D6000);
            root.Last().AddLine(D9999);
            root.Last().AddParsedData(D1000);
            root.Last().Datas.Last().AddField("id", "091478132009002", typeof(string));
            root.Last().Datas.Last().AddLine(D3001);
            root.Last().Datas.Last().AddLine(D3001);
            root.Last().Datas.Last().AddParsedData(D4000);
            root.Last().Datas.Last().Datas.Last().AddParsedData(P0000);
            ...
            Assert.AreEqual(3, root.First().Datas.Count);
            Assert.AreEqual(5, root.First().Datas.First().Lines.Count);
